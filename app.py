...
# =====================================================
st.set_page_config(page_title="Predicción del Precio de Casas", page_icon="🏠", layout="centered")

# =====================================================
# Estilos con el color #B78FB1
# =====================================================
st.markdown("""
    <style>
...
# =====================================================
# 1. Datos base: se guardan en session_state para poder
#    modificarlos (subir CSV nuevo / agregar dato manual)
# =====================================================
...
if "df" not in st.session_state:
    st.session_state.df = cargar_datos_originales()
...
with st.expander("⚙️ Administrar los datos de entrenamiento"):
    ...
    if col_m3.button("Agregar dato"):
        ...
        st.session_state.df = pd.concat([st.session_state.df, fila_nueva], ignore_index=True)
        st.success(f"Dato agregado: {nuevo_m2} m² → ${nuevo_precio:,.0f}. Modelo actualizado con toda la información.")

    st.caption(f"Registros usados actualmente: **{len(st.session_state.df)}**")

df = st.session_state.df

# =====================================================
# 2. Entrenar el modelo con los datos actuales
#    (se re-ejecuta automáticamente cada vez que df cambia)
# =====================================================
...
# =====================================================
# 3. Único input principal: metros cuadrados
# =====================================================
m2 = st.number_input(
...
# =====================================================
# 4. Al presionar el botón: precio + plano + gráfica
# =====================================================
if calcular:
    ...
    # ---- Gráfica de dispersión con la predicción ----
